...
export const SKILLS = [
  ...
  { name: "Django Rest Framework", initialRating: 4 },
  { name: "API integration", initialRating: 4 },
...
export const TOOLS = ["Visual Studio Code", "Git", "Chrome DevTools", "Npm (Node Package Manager)", "Atom",  "Linux", "Heroku", "Postman"]
